...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script type="javascript" src="{{ url('pptx/js/jquery.fullscreen-min.js') }}"></script>
        <script>
    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{ route('adminmanagepeserta') }}"><span class="nav-icon"></span> Manage Peserta</a></li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-star"></use>
            </svg> Stream & Peserta</a>
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{ route('streamjuri') }}"> Manage Juri</a></li>
            <li class="nav-item"><a class="nav-link" href="icons/coreui-icons-brand.html"> CoreUI Icons - Brand</a></li>
            <li class="nav-item"><a class="nav-link" href="icons/coreui-icons-flag.html"> CoreUI Icons - Flag</a></li>
          </ul>
        </li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{route('streamjuri')}}">
                <svg class="nav-icon">
                  <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
                </svg> Steam</a></li>
            <li class="nav-item"><a class="nav-link" href="register.html" target="_top">
